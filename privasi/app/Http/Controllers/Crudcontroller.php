...
class Crudcontroller extends Controller
{
    ...
    public function editdata($kode_kue){
        $data = DB::table('kue')->where('kode_kue','=', $kode_kue)->first();
    ...
    public function proseseditdata(){
        ...
        DB::table('kue')->where('kode_kue', '=', request()->get('kode_kue'))->update($data);
    ...
    public function tambahkeranjang($kode_kue){
        ...
        $data_kue = DB::table('kue')->where('kode_kue','=', $kode_kue)->first();
    ...
    public function hapuskeranjang($kode_kue){
        $query = DB::table('keranjang')->where('kode_kue','=', $kode_kue);
        $data = $query->first();
        $query->delete();
    ...
    public function report($kode_kue){
        ...
        $data_kue = DB::table('transaksi')->where('kode_kue','=', $kode_kue)->first();
        ...
        DB::table('report')->insert($data_report);


        $data_kue_update = DB::table('kue')->where('kode_kue','=', $kode_kue)->first();
        ...
        DB::table('kue')->where('kode_kue', '=', $kode_kue)->update($data_update);

        $query = DB::table('transaksi')->where('kode_kue','=', $kode_kue);
        $data = $query->first();
        $query->delete();
