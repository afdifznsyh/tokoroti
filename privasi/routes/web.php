...
Route::middleware('web')->group(function () {
    ...
    Route::post('register', [Crudcontroller::class, 'tambahuser']);
    Route::get('register', [Crudcontroller::class, 'register']);
});

Route::middleware('auth')->group(function () {
    Route::get('tambahkue', [Crudcontroller::class, 'tambahdatakue']);
    Route::get('keluar_admin', [Crudcontroller::class, 'keluaradmin']);
    Route::get('logout', [Crudcontroller::class, 'keluaruser'])->name('logout');
